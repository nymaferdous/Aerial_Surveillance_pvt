...
class PyramidVisionTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        # x1=self.spp(x1)
        # print("X1 After Average Pool", x1.shape)
        # # print("X1  Shape", x1.shape)
        # x2 = self.spp(x2)
        # print("X2  after avg pool Shape", x2.shape)
        # x3 = self.spp(x3)
        # print("X3  after avg pool", x3.shape)
        # # print("X4 shape",x4.shape)
        # x4 = self.spp(x4)
        # print("After X4  avg pool Shape", x4.shape)
        x1= x1.view(B,-1)
        x2 = x2.view(B, -1)
        x3 = x3.view(B, -1)
        x4 = x4.view(B, -1)
        x5=torch.cat((x1,x2,x3,x4),1)
        x5=x5.reshape(B,-1,768)
        x6 = self.spp(x5)
        x6 = self.norm(x6)
