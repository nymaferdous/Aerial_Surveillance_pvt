...
def get_default_config():
    ...
    # cfg.model.name = 'crossattention'
    # cfg.model.name = 'vit'
    # cfg.model.name = 'pvt'
    cfg.model.name='vit'
    cfg.model.pretrained = False # automatically load pretrained model weights if available
    # cfg.model.load_weights = '/media/nyma/0e9cb3b9-b422-4047-a34b-8ecacb40dea7/Nyma/pvt_large.pth' # path to model weights
    cfg.model.resume =''
    # data
    cfg.data = CN()
    cfg.data.type = 'image'
    ...
    cfg.train.open_layers = ['head'] # layers for training while keeping others frozen
    ...
    cfg.loss.triplet.weight_x = 0.3 # weight to balance cross entropy loss
